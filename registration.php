...
function get($userName){
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" name="registration" onsubmit="return regValid();"> 
		<fieldset>
	...
	<span style="color: red" name="fnameError"> <?php echo $fnameError; ?></span><br><br>

	<span style="color: red">*</span>
	<label for="lname">Last Name</label>
	<input type="text" name="lname" id="lname">
	 <span style="color: red" name="lnameError"> <?php echo $lnameError; ?></span><br><br>

	<span style="color: red">*</span>
	Gender <input type="radio" name="gender" id="male" value="male"> <label for="male">Male</label>
	<input type="radio" name="gender" id="female" value="female">  <label for="female">Female</label> 
	<span style="color: red" name="genderError"><?php echo $genderError; ?> </span><br><br>

	<span style="color: red">*</span>
	<label for="dob">Date of Birth </label>
	<input type="Date" name="dob" id="dob" > 
	<span style="color: red" name="dobError"><?php echo $dobError; ?> </span><br><br>
	...
	</select> <span style="color: red" name="religionError"> <?php echo $religionError; ?></span>
</fieldset> <br>
...
<fieldset>
	...
	<span style="color: red" name="praddressError"> <?php echo $praddressError; ?></span><br><br>

	<span style="color: red">*</span>
	<label for="peaddress">Permanent Address </label>
	<textarea id="peaddress" rows="2" cols="30" name="peaddress"></textarea>
	 <span style="color: red" name="peaddressError"> <?php echo $peaddressError; ?></span><br><br>

	<span style="color: red">*</span>
	<label for="phoneNumber">Phone </label>
	<input type="tel" name="phoneNumber" id="phoneNumber">
	  <span style="color: red" name="phoneError"> <?php echo $phoneError; ?></span><br><br>

	<span style="color: red">*</span>
	<label for="mail">Email </label>
	<input type="Email" name="mail" id="mail">
	 <span style="color: red" name="emailError"> <?php echo $emailError; ?></span><br><br>

<span style="color: red">*</span>	
<label for="web">Personal Website Link </label>
	<input type="url" name="web" id="web">
 <span style="color: red" name="webError"> <?php echo $webError; ?></span>
...
<fieldset>
 ...
 <span style="color: red" name="userError"> <?php echo $userError; ?></span><br><br>

	<span style="color: red">*</span>
	<label for="password">Password </label>
	<input type="password" name="password" id="password">
	 <span style="color: red" name="passwordError"> <?php echo $passwordError; ?></span><br><br>
...
<input type="submit" name="submit" value="Submit">
	...
	<a href="login.php">Login Here</a><br>
	 ...
	 <span style="color: green" name="Successful"> <?php echo $Successful; ?>  </span>
<span style="color: red" name="Error"><?php echo $Error ;  ?></span>
